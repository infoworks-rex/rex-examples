...
tf.flags.DEFINE_string('X_input_dir', 'data/horse2zebra/trainA',
                       'X input directory, default: data/horse2zebra/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/horse2zebra/trainB',
                       'Y input directory, default: data/horse2zebra/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/horse.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/horse.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/zebra.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/zebra.tfrecords')
